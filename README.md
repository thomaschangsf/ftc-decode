...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;git clone https://github.com/FIRST-Tech-Challenge/ftc-decode.git</p>

* Or, if you prefer, you can use the "Download Zip" button available through the main repository page.  Downloading the project as a .ZIP file will keep the size of the download manageable.

* You can also download the project folder (as a .zip or .tar.gz archive file) from the Downloads subsection of the [Releases](https://github.com/FIRST-Tech-Challenge/ftc-decode/releases) page for this repository.
...
Samples Folder: &nbsp;&nbsp; [/ftc-decode/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples](ftc-decode/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples)
...
* The behavior of setGlobalErrorMsg() is changed.  Note that this is an SDK internal method that is not 
  ...
  Addresses issue [1381](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/1381)
...
### Bug Fixes
* Fixes issue [1478](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/1478) in AnnotatedHooksClassFilter that ignored exceptions if they occur in one of the SDK app hooks.
* Fix initialize in distance sensor (Rev 2m) to prevent bad data in first call to getDistance.
* Fixes issue [1470](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/1470) Scaling a servo range is now irrespective of reverse() being called.  For example, if you set the scale range to [0.0, 0.5] and the servo is reversed, it will be from 0.5 to 0.0, NOT 1.0 to 0.5.
* Fixes issue [1232](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/1232), a rare race condition where using the log rapidly along with other telemetry could cause a crash.
...
* Fix an internal bug where if the RUN_TO_POSITION run mode was specified before a target position, recovery would require a power cycle. A side effect of this fix is that a stack trace identifying the location of the error is always produced in the log. Fixes issue [1345](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/1345).
* Throws a helpful exception if region of interest is set to null when building a PredominantColorProcessor. Also sets the default RoI to the full frame. Addresses issue [1076](FIRST-Tech-Challenge/ftc-decode#1076)
* Throws a helpful exception if user tries to construct an ImageRegion with malformed boundaries.  Addresses issue [1078](FIRST-Tech-Challenge/ftc-decode#1078)
...
### Bug Fixes
* Fixes [AngularVelocity conversion regression](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/1070)
...
### Bug Fixes
* Fixes https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/942 where visionPortal.close() can cause an IndexOutOfBoundsError.
...
* [Issue #764](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/764) - Get gain control returns a null pointer for a switchable camera
...
* [Issue #492](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/492) - Can't create new blocks opmodes.
* [Issue #495](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/495) - Remove the final modifier from the OpMode's Telemetry object.
* [Issue #500](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/500) - Some devices cannot be configured when the Driver Station app has been updated to 8.1
...
* Fixes [issue #251](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/251) by changing the order in which axis rotation rates are read from the angular velocity vector in the BNO055 IMU driver.
...
* Adds new Java sample to demonstrate using a hardware class to abstract robot actuators, and share them across multiple OpModes.
  * Sample OpMode is [ConceptExternalHardwareClass.java](ftc-decode/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples/ConceptExternalHardwareClass.java)
  * Abstracted hardware class is [RobotHardware.java](ftc-decode/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples/RobotHardware.java)
...
* Adds opt-in support for Java 8 language features to the OnBotJava editor.
  ...
  * Please report issues [here](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues).
...
### Bug fixes
* Fixes [issue #316](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/316) (MatrixF.inverted() returned an incorrectly-sized matrix for 1x1 and 2x2 matrixes).
...
* Fixes crash when calling `isPwmEnabled()` ([issue #223](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/233)).
* Fixes lint error ([issue #4](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/4)).
* Fixes Driver Station crash when attempting to use DualShock4 v1 gamepad with Advanced Gamepad Features enabled ([issue #173](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/173)).
...
* Fixes [issue #259](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/259) Most blocks samples for TensorFlow can't be used for a different model.
...
* Fixes [issue #260](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/260) Blocks can't call java method that has a VuforiaLocalizer parameter.
...
* Updates samples located at [/ftc-decode/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples](ftc-decode/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples).
 ...
 * Fixes [ftc-decode issue #114](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/114)
...
### Bug fixes
* Fixes [ftc-decode issue #71](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/71)
  Cannot open OpModes in v6.1 Blocks offline editor
* Fixes [ftc-decode issue #79](https://github.com/FIRST-Tech-Challenge/ftc-decode/issues/79)
...
* Introduces an automatic TeleOp preselection feature
    * For details and usage guide, please see [this wiki entry](https://github.com/FIRST-Tech-Challenge/ftc-decode/wiki/Automatically-Loading-a-Driver-Controlled-Op-Mode)
