...
public class TotalTeleOpv12 extends LinearOpMode {
    ...
    private static final double PIXELS_NEAR = 150.0;   // HuskyLens tag width (in pixels) considered "near"
    private static final double PIXELS_FAR = 40.0;     // Width considered "far"
    private static final double DEFAULT_SHOOT_POWER = 0.69;

    private static final int TARGET_TAG_ID = -1;       // -1 tracks the first tag we see
    private static final double TURN_GAIN = 0.003;     // Converts pixel offset into a gentle turn command
    private static final int FRAME_CENTER_X = 160;     // HuskyLens horizontal resolution midpoint (320px wide)
